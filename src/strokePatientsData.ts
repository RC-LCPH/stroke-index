...
export const scenarios = [
   ...
   // { name: 'Lucy Locklear', description: 'Drowsiness and garbled speech', imageUrl: '/stroke-index/assets/cards-img/Mood_LucyLocklear.png', status: 'Incomplete', url: LUCY_LOCKLEAR_URL },
    ...
    { name: 'Nam Truong', description: 'Right arm weakness and difficulty speaking', imageUrl: '/stroke-index/assets/cards-img/Mood_NamTruong.png', status: 'Incomplete', url: NAM_TRUONG_URL },
    { name: 'Adair Canton', description: 'Dizziness and difficulty walking', imageUrl: '/stroke-index/assets/cards-img/Mood_AdairCanton.png', status: 'Incomplete', url: ADAIR_CANTON_URL },
    { name: 'Leona Abrams', description: 'Sudden severe headache', imageUrl: '/stroke-index/assets/cards-img/Mood_LeonaAbrams.png', status: 'Incomplete', url: LEONA_ABRAMS_URL },
  ];